...
namespace LaunchDarkly.Api.Model {
  ...
  public class FeatureFlagApprovalRequest {
    ...
    public FeatureFlagApprovalRequestReviewStatus ReviewStatus { get; set; }
    ...
    /// </summary>
    /// <value>| Name     | Description | | - -- -- -- -:| - -- -- -- -- -- | | pending  | the feature flag approval request has not been applied yet | | completed| the feature flag approval request has been applied successfully | | failed   | the feature flag approval request has been applied but the changes were not applied successfully | </value>
    ...
    public List<FeatureFlagApprovalRequestReview> AllReviews { get; set; }

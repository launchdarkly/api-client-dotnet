...
namespace LaunchDarkly.Api.Model {
  ...
  public class FeatureFlagChangeRequestReview {
    ...
    /// </summary>
    /// <value>A unix epoch time in milliseconds specifying the date the change request was reviewed</value>
    ...
    public FeatureFlagChangeRequestReviewStatus Kind { get; set; }
